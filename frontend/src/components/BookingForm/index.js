...
import { Form, Select, DatePicker, InputNumber, Button, Input, message } from 'antd';
    ...
    const onFinish = async values => {
        ...
        try {
            ...
            if (values.discount_id) {
                payload.discount_id = values.discount_id; // discount as text
            }
